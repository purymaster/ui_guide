(function ($) {
	...
	function setFileUpload() {
		...
		function checkError(error, obj) {
			switch (error) {
				case "size": alert("첨부파일은 " + Math.floor(limitSize / 1048576) + "MB까지 업로드 가능합니다."); break;
				case "file": alert('허용된 확장자 : gif, jpg, jpeg, png, doc, docx, ppt, pptx, xls, xlsx, pdf, txt, zip'); break;
				case "img": alert('허용된 확장자 : gif, jpg, jpeg, png'); break;
			};
			obj.val("");
